...
contourPointsMap1Refine, contourPointsMap2Refine, contourPointsMap3Refine = util.deform(inputContourPointsRefine, poseLines[5], poseLines[6], -math.pi/8, -math.pi/2.5, False)  
for point in contourPointsMap1Refine:
    ww, hh = point
    workImage[hh, ww] = (0, 0, 255)
for point in contourPointsMap2Refine:
...
contourPointsMap1Refine, contourPointsMap2Refine, contourPointsMap3Refine = util.deform(inputContourPointsRefine, poseLines[8], poseLines[9], -math.pi/12, 0, True)  
for point in contourPointsMap1Refine:
    ww, hh = point
    workImage[hh, ww] = (0, 0, 255)
for point in contourPointsMap2Refine:
...
contourPointsMap1Refine, contourPointsMap2Refine, contourPointsMap3Refine = util.deform(inputContourPointsRefine, poseLines[11], poseLines[12], math.pi/6, -math.pi/4, False)  
for point in contourPointsMap1Refine:
    ww, hh = point
    workImage[hh, ww] = (0, 0, 255)
for point in contourPointsMap2Refine:
